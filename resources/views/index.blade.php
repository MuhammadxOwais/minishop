        ...
        <div class="container">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                        <div class="product">
                            <a href="#" class="img-prod">
                                <img class="img-fluid" src="{{ $u->product_image }}" style="height: 320px; width: 100%;"
                            ...
                            <div class="text py-3 pb-4 px-3">
                                ...
                                <div class="quantity">
                                    <input type="number" name="quan" id="quantity"
                                    min="1" max="20" value="1">
                                </div>
                                <p class="bottom-area d-flex px-3">
                                    <a href="#" class="add-to-cart text-center py-2 mr-1"
                                        data-product-id="{{ $u->id }}" data-product-name="{{ $u->product_name }}"
                                        data-product-image="{{ $u->product_image }}"
                                        data-product-price="{{ $u->product_price }}"
                                        data-totalprice="{{$u->product_price}}">
            ...
            <div id="cart-sidebar" class="cart-sidebar" style="display: none;">
                ...
                <div class="total mt-5">
                    <h6>TOTALITEMS:<span id="total_items"></span></h6>
                    <h6>TOTALPRICES:<span id="total_prices"></span></h6>
                </div>
                <div class="buy-btn">
            ...
            <style>
                ...
                .cart-sidebar {
                    ...
                    height: 100%;
                    background: #fff;
                    box-shadow: -2px 0 5px rgb(246, 246, 246);
                    padding: 20px;
                    z-index: 1000;
                }
            </style>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    document.querySelectorAll('.add-to-cart').forEach(button => {
                        button.addEventListener('click', function(event) {
                            ...
                            const totalPrice = this.getAttribute('data-product-price');
                            ...
                            document.getElementById('total_prices').innerText = total_price;
                            ...
                            imageElement.style.width =
                                '60px'; // Set the width to 50px (you can change this)
                            imageElement.style.height =
                                '60px'; // Set the height to 50px (you can change this)
