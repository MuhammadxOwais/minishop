        ...
        <table class="table">
            ...
            @foreach ($cosmdata as $u)
                <tr>
                    ...
                    <td><a href="/cosdeleted/{{ $u->id }}"><i class="fa-solid fa-trash"
                                style="font-size: 25px; text-align: center; margin-left: 15px;"></i></a></td>
                    <td><a href="/cosupdate/{{ $u->id }}"  style="font-size: 25px; text-align: center; margin-left: 15px;"><i class="fa-solid fa-pen-nib"></i></a></td>
                </tr>
            @endforeach
        </table>
    </div>
