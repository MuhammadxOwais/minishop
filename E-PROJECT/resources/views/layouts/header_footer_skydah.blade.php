...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo ml-2" style="font-weight: bolder;"
                    href="dashboard">Mini_Dashboard</a>
    ...
    <script src="skydash-stylejs/hoverable-collapse.js"></script>
    <script src="skydash-stylejs/template.js"></script>
    <script src="skydash-stylejs/settings.js"></script>
    <script src="skydash-stylejs/todolist.js"></script>
    <!-- endinject -->
    <!-- Custom js for this page-->
    <script src="skydash-stylejs/dashboard.js"></script>
    <script src="skydash-stylejs/Chart.roundedBarCharts.js"></script>
