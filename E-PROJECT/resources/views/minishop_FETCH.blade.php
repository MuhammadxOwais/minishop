        ...
        <table class="table">
            ...
            @foreach ($minidata as $u)
                <tr>
                    ...
                    <td><a href="/minideleted/{{ $u->id }}"><i class="fa-solid fa-trash"
                                style="font-size: 25px; text-align: center; margin-left: 15px;"></i></a></td>
                    <td><a href="/miniupdate/{{ $u->id }}"  style="font-size: 25px; text-align: center; margin-left: 15px;"><i class="fa-solid fa-pen-nib"></i></a></td>
                </tr>
            @endforeach
        </table>
    </div>
